...
const AdminArticle = () => {
  ...
  return (
    <div className="max-w-full">
      <h1 className="max-sm:left-0 fixed top-[120px] right-0 left-[180px] mx-[20px] py-[10px] text-[32px] bg-white font-bold text-center z-10">
      ...
      <div className="shadow-md sm:rounded-lg ">
        ...
        <div className="flex flex-col">
          ...
          <div className="max-sm:left-0 text-xs fixed top-[180px] right-0 left-[180px] mb-[20px] mx-[20px] flex text-gray-700 uppercase bg-gray-50 border-b-[2px] border-b-borderColor z-10">
            {/* Tất cả bài viết  */}
            <div className="w-1/3 h-[40px] text-center border-r-[2px] border-r-borderColor">
              <Link
                className={`max-sm:text-[10px] block font-bold w-full h-full leading-[40px] hover:bg-bgHoverColor ${
